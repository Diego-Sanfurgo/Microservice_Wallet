...
Future<Response> withdrawAmount(Request request) async {
  ...
  Movement newMovement = await Movement.fromBody(body, MovementType.withdrawal);
  ...
  switch (response) {
    ...
    case ResponseStatus.SUCCESS:
      ...
      Map totalAmount = await Movement.getBalanceByWallet(move.walletId);

      return Response.ok(
          movementResponseDTO(move, totalAmount.values.first).toString());
